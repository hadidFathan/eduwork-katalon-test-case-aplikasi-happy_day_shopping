...
Mobile.startApplication('C:\\Users\\siegh\\OneDrive\\Documents\\Automation\\eduword_katalon_case_calculator\\androidapp\\Shop_samsung.apk', 
    true)
...
Mobile.scrollToText('Samsung Galaxy SmartTag', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Mobile/Samsung_shope_test/android.widget.TextView - Samsung Galaxy SmartTag, 1-Pack, Denim Blue'), 
    0)
