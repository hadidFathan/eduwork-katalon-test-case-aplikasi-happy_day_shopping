...
Mobile.tap(findTestObject('Object Repository/FlashSaleHappy/android.widget.Button - INSTAL'), 0)
...
Mobile.tap(findTestObject('Object Repository/FlashSaleHappy/android.widget.TextView - Add to Bag (1)'), 0)
